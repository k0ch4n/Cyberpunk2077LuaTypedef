...
function gamedataKeepCurrentCoverCoverSelectionParameters_Record.new(fields) end

---@return Float
function gamedataKeepCurrentCoverCoverSelectionParameters_Record:KeepCoverBonus() end
