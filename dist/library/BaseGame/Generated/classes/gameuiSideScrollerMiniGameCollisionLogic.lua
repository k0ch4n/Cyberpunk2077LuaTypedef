...
function gameuiSideScrollerMiniGameCollisionLogic.new(fields) end

---@param state gameuiMinigameState
---@return nil
function gameuiSideScrollerMiniGameCollisionLogic:UpdateGameState(state) end
