...
function gamedataOwnerThreatCoverSelectionParameters_Record.new(fields) end

---@return Float
function gamedataOwnerThreatCoverSelectionParameters_Record:OwnerThreatCoverAngle() end
