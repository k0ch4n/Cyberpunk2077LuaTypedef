...
---@field logicalOrientationProvider entIOrientationProvider
---@field visualPositionProvider entIPositionProvider
...
function gameprojectileLaunchParams.new(fields) end
