...
---@return String
function gamedataNPCUpperBodyState_Record:Comment() return end

---@return CName
function gamedataNPCUpperBodyState_Record:EnumName() return end

---@return gamedataNPCUpperBodyState
function gamedataNPCUpperBodyState_Record:Type() return end
