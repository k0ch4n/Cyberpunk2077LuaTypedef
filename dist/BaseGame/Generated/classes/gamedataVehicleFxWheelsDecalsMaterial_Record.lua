...
function gamedataVehicleFxWheelsDecalsMaterial_Record:Material() return end

---@return gamedataMaterial_Record
function gamedataVehicleFxWheelsDecalsMaterial_Record:MaterialHandle() return end

---@return redResourceReferenceScriptToken
function gamedataVehicleFxWheelsDecalsMaterial_Record:Skid_marks_decal() return end

---@return redResourceReferenceScriptToken
function gamedataVehicleFxWheelsDecalsMaterial_Record:Tire_tracks_decal() return end
