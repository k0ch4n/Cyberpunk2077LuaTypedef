...
function OpenFastTravelMenuForLastVisitedSubwayGate.new(fields) return end

---@return String
function OpenFastTravelMenuForLastVisitedSubwayGate:GetFriendlyDescription() return end
