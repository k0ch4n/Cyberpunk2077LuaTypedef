...
---@param fields? questCharacterGroupAttitude_CondtionType
---@return questCharacterGroupAttitude_CondtionType
function questCharacterGroupAttitude_CondtionType.new(fields) return end
